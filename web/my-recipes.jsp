...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/2990652e30.js" crossorigin="anonymous"></script>
        <title>Recipes</title>
    </head>
    <body>
        <c:choose>
            ...
            <c:otherwise>
                ...
                <div class="container px-6 mx-auto">
                    ...
                    <div class="flex flex-row flex-wrap">
                        <c:forEach var="recipe" items="${recipesByUser}">
                            <div class="flex basis-2/5 m-6 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                                ...
                                <div class="w-2/3 p-4 md:p-4">
                                    <div class="flex justify-end">
                                        <a href="delete-recipe?id=${recipe.getRecipeID()}" class="text-sm font-bold text-gray-700 dark:text-gray-200 md:text-sm mx-2"><i class="fa-solid fa-trash-can"></i></a>
                                        <a href="update-recipe?id=${recipe.getRecipeID()}" class="text-sm font-bold text-gray-700 dark:text-gray-200 md:text-sm mx-2"><i class="fa-solid fa-pen-to-square"></i></a>
                                    </div>
