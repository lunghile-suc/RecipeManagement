    ...
    <body class="dark:bg-gray-800">
        ...
        <form action="account" method="post">
            <section class="max-w-4xl p-6 mx-auto my-8 bg-white rounded-md shadow-md dark:bg-gray-800">
                <h2 class="text-4xl mb-6 font-semibold text-gray-700 capitalize dark:text-white">Update Account</h2>

                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="firstName">First Name:</label>
                        <input id="firstName" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="firstName" value="${singleUser.getFirstName()}">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="surname">Surname: </label>
                        <input id="surname" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="surname" value="${singleUser.getSurname()}">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="email">Email Address:</label>
                        <input id="email" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="email" value="${singleUser.getEmail()}">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="phoneNo">Phone No:</label>
                        <input id="phoneNo" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="phoneNo" value="${singleUser.getPhoneNo()}">
                    </div>

                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="gender">Gender:</label>
                        <select class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="gender">                           
                            <option><c:out value="${singleUser.getGender()}" /></option>
                            <option>Male</option>
                    ...
                    <div>
                        ...
                        <input id="address" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" name="address" value="${singleUser.getAddress()}">
                    </div>
